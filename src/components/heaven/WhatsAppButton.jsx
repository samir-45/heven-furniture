...
// The one and only call-to-action style on the page — repeated, never competing.
// Solid: bronze fill on light + dark sections. Outline: hairline bronze on light sections.
export default function WhatsAppButton({
  ...
  const base =
    ...
    "px-7 py-3.5 text-[0.92rem] font-medium tracking-wide " +
