...
export default function Collections() {
  ...
  return (
    <section id="collections" className="scroll-mt-24 bg-bone py-16 md:py-24">
        ...
        <div className="flex items-end justify-between gap-6 mb-10 md:mb-14">
          ...
          <div className="hidden md:flex gap-2">
            <button
              ...
              className="h-11 w-11 rounded-full border border-ink/20 text-ink/70 hover:bg-bronze hover:text-bone hover:border-bronze transition-colors flex items-center justify-center"
            >
...
/>
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <p className="mt-1 text-bone/75 text-sm leading-relaxed max-w-[16rem]">
                  {t(`collections.${ck}.line`)}
                </p>
                <span className="mt-4 inline-flex items-center gap-1.5 text-brass text-[0.72rem] uppercase tracking-[0.2em] opacity-0 -translate-y-1 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0">
                  {t("collections.enquire")} <ArrowRight className="h-3.5 w-3.5" />
                </span>
              </div>
            </div>
            <span className="mt-3 block text-[0.62rem] uppercase tracking-[0.24em] text-ink/35">
