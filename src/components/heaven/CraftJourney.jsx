  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col justify-start pt-16 sm:pt-20 md:pt-24">
        ...
        <motion.div style={{ x }} className="flex gap-4 sm:gap-6 md:gap-10 px-4 sm:px-6 md:px-10 will-change-transform">
          {chapterKeys.map((ck, i) => (
            <article
              key={ck}
              className="relative shrink-0 w-[84vw] sm:w-[60vw] md:w-[44vw] lg:w-[34vw] h-[52vh] sm:h-[54vh] md:h-[58vh] overflow-hidden rounded-sm bg-cocoa"
            >
              <Image
                src={chapterImgs[i]}
                alt={chapterAlts[i]}
                ...
                fittingType="fill"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-depth/90 via-depth/35 to-depth/10" />
              <div className="absolute top-4 left-4 sm:top-6 sm:left-6 md:top-8 md:left-8 font-heading text-bone/80 text-3xl sm:text-4xl md:text-5xl font-light">
                0{i + 1}
              </div>
